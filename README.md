...
classes beyond `plain` (borderless layout table) and `caption` (figure
caption). The page is readable on a phone as is: a viewport meta tag,
...
| Path                            | Purpose                                                                  |
| ------------------------------- | ------------------------------------------------------------------------ |
| `index.md`                      | Home: contact block, biography, research, recent news                    |
